...
/**
 * Pygment class
 * This is a simple class that wraps `pygments`
 * If the `pygmentize` command is available locally it uses that,
 * otherwise a webservice is used to perform the same function.
 * @author Ross Riley
 **/
